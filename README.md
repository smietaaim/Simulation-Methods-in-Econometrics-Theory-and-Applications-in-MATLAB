...
## Why MATLAB
MATLAB was chosen for its intuitive syntax, strong editing environment, and natural handling of matrix operations. Because vector and matrix algebra form the core of the exercises in this book, MATLAB provides a framework that aligns directly with the pedagogical goals of this project. To support readers who are new to MATLAB, a dedicated workshop is included in this repository.
